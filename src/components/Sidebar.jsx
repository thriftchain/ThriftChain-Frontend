...
const Sidebar = () =>  {
  ...
  return (
    <div className='bg-[#060E37] w-[25%] text-white p-8 py-12 h-[85vh]'>
      <NavLink to="/dashboard" className="text-[18px] flex items-center py-4 mb-4 px-4" style={({isActive}) => isActive ? activeStyle : null }><CgHomeAlt className="mr-4" />Dashboard</NavLink>
